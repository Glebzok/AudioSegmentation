...
if __name__ == '__main__':
    ...
    parser.add_argument('-params', help='Parameter file (yaml) for the evaltest mixtures ',
                        required=False, default='mixing_params_evaltest.yaml', dest='params')
    args = parser.parse_args()

    main(data_path=args.data_path,
         generate_devtrain_recipes=False,
         generate_devtest_recipes=False,
         generate_evaltest_recipes=True,
         synthesize_devtrain_mixtures=False,
         synthesize_devtest_mixtures=False,
         synthesize_evaltest_mixtures=True,
